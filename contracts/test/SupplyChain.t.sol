...
contract SupplyChainTest is Test {
    ...
    function testCreateTokenByFactory() public {
        ...
        parentAmounts[0] = 1000; // 1 * 1000 (el contrato divide por 1000 para obtener 1)
    ...
    function testCreateTokenByRetailer() public {
        ...
        ssccParentAmounts[0] = 1000; // 1 * 1000 (el contrato divide por 1000 para obtener 1)
    ...
    function testTokenWithParentIds() public {
        ...
        // Crear token hijo (PT_LOTE) con parentIds = [1] (la receta) y parentAmounts = [1000]
        uint256[] memory parentIds = new uint256[](1);
        parentIds[0] = 1; // ID de la receta
        uint256[] memory parentAmounts = new uint256[](1);
        parentAmounts[0] = 1000; // 1 * 1000 (el contrato divide por 1000 para obtener 1)
        ...
        assertEq(childToken.parentAmounts[0], 1000); // El contrato almacena el valor multiplicado por 1000
    }
    ...
    function testTraceabilityFlow() public {
        ...
        recipeParentAmounts[0] = 1000; // 1 * 1000 (1 unidad de materia prima por unidad de producto)
        ...
        assertEq(recipe.parentAmounts[0], 1000); // 1 * 1000 (1 unidad de materia prima por unidad de producto)
        assertEq(processedProduct.parentIds.length, 1); // Derivado de la receta (token 2)
        assertEq(processedProduct.parentIds[0], 2);
        assertEq(processedProduct.parentAmounts[0], 1000); // 1 * 1000 (1 receta por lote)
    ...
    function testCreateLotWithRecipeConsumesComponents() public {
        ...
        recipeParentAmounts[0] = 10000; // 10 * 1000 (10 unidades de A por unidad de producto)
        recipeParentAmounts[1] = 5000;  // 5 * 1000 (5 unidades de B por unidad de producto)
        ...
        lotParentAmounts[0] = 1000; // 1 * 1000 (el contrato divide por 1000 para obtener 1)
    ...
    function testCreateLotWithInsufficientComponents() public {
        ...
        recipeParentIds[0] = 1;
        uint256[] memory recipeParentAmounts = new uint256[](1);
        recipeParentAmounts[0] = 10000; // 10 * 1000 (10 unidades por producto)
    ...
    function testCreateLotRequiresExactlyOneParent() public {
        ...
        lotParentAmounts[0] = 1000; // 1 * 1000
        lotParentAmounts[1] = 1000; // 1 * 1000
    ...
    function testCreateLotWithMultipleComponents() public {
        ...
        recipeParentAmounts[0] = 5000;  // 5 * 1000 (5 de A por unidad)
        recipeParentAmounts[1] = 3000;  // 3 * 1000 (3 de B por unidad)
        recipeParentAmounts[2] = 2000;  // 2 * 1000 (2 de C por unidad)
