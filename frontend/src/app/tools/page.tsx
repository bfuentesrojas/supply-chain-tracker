...
interface ApiResponse {
  success: boolean
  error?: string
  details?: any[] | { suggestion?: string; [key: string]: any }
  suggestion?: string
  [key: string]: any
}
                  ...
                  <div className="text-sm">
                    {results.fundAccounts.success ? (
                      ...
                      <>
                        ...
                        {results.fundAccounts.details && 
                         typeof results.fundAccounts.details === 'object' && 
                         !Array.isArray(results.fundAccounts.details) &&
                         (results.fundAccounts.details as { suggestion?: string }).suggestion && (
                          <div className="text-xs text-yellow-700 bg-yellow-50 p-2 rounded mt-2">
                            💡 <strong>Sugerencia:</strong> {(results.fundAccounts.details as { suggestion: string }).suggestion}
                          </div>
                        )}
                  ...
                  <div className="text-sm">
                    {results.fundAccount.success ? (
                      ...
                      <>
                        ...
                        {results.fundAccount.details && 
                         typeof results.fundAccount.details === 'object' && 
                         !Array.isArray(results.fundAccount.details) &&
                         (results.fundAccount.details as { suggestion?: string }).suggestion && (
                          <div className="text-xs text-yellow-700 bg-yellow-50 p-2 rounded mt-2">
                            💡 <strong>Sugerencia:</strong> {(results.fundAccount.details as { suggestion: string }).suggestion}
                          </div>
                        )}
