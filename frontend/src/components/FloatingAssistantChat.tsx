...
/**
 * Componente de chat flotante para el asistente de IA
 * Permite interactuar con el sistema usando lenguaje natural
 * 
 * Funcionalidades:
 * - Consultas sobre usuarios, tokens, transferencias
 * - Ejecución de acciones sobre el contrato (requiere confirmación)
 * - Mantiene contexto de conversación
 * - Integración con MetaMask para transacciones
 * 
 * @example
 * ```tsx
    ...
    try {
      ...
      switch (action) {
        case 'change_user_status': {
          ...
          if (params.userAddress?.toLowerCase() === adminAddress.toLowerCase()) {
            throw new Error('No se puede cambiar el estado del administrador. El administrador siempre debe estar aprobado.')
          }
