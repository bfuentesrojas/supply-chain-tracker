...
### 1. Servidor API MCP (Puerto 3002)
```bash
...
### 2. Frontend MCP Tools (Puerto 3001)
```bash
# Desde la raíz del proyecto
./start-tools.sh
...
Una vez iniciado:
- **API MCP**: http://localhost:3002
- **Frontend Tools**: http://localhost:3001/tools
- **Frontend Principal (dApp)**: http://localhost:3000

## Configuración de Puertos

- **3000**: Frontend principal (dApp de tracking)
- **3001**: Frontend de herramientas MCP
- **3002**: API MCP (servidor Express)
